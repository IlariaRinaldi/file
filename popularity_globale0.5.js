...
var locpop = require (__dirname+'/popularity0.5.js');
...
var period_time=50000;		//in secondi
//locpop.reset();
//preUpdate();
...
//Funzione che si autochiama periodicamente, ogni period_time.
//Ogni ciclo vengono prelevati e salvati tutti i dati dagli altri gruppi (updateGruppi e updateRel)
//e vengiene aggiornato il database, sommando i risultati ottenuti, in modo da avere i dati in una
//forma semplice da leggere e restituire al server e quindi all'utente
